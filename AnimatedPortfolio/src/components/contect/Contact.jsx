...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // In a real app, you'd send this to EmailJS, Formspree, or your backend here
    ...
    <section id="contact" className="contact-section" ref={containerRef}>
      ...
      <div className="contact-header-container">
        ...
        <p className="contact-subtitle">
          Have a project in mind or looking for a skilled MERN developer? Let's build something great together.
        </p>
      </div>
          ...
          <div className="info-box social-hover-box">
            ...
            <div className="info-text social-text-container">
              ...
              <div className="hidden-socials">
                {/* LinkedIn */}
                <a href="https://linkedin.com/in/sudhanshubaberwal" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                ...
                {/* Instagram */}
                <a href="https://instagram.com/sudhanshubaberwal272" target="_blank" rel="noreferrer" aria-label="Instagram">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
