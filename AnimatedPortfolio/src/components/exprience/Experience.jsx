          ...
          <div className="view-expanded">
            ...
            <div className="exp-content">
              <div className="exp-stats-box">
                <p>
                  Global Ranking:{" "}
                  <strong>#{lRanking ? lRanking.toLocaleString() : "0"}</strong>
                </p>
                <p>
                  Badges Earned: <strong>{lBadgeCount}</strong>
                </p>

                <div style={{ marginTop: "20px" }}>
                  <p style={{ marginBottom: "10px" }}>
                    Latest Badge:{" "}
                    <strong style={{ color: "#ffc01e" }}>
                      {lActiveBadge || "None"}
                    </strong>
                  </p>
        ...
        >
          ...
          <div className="view-compact">
            ...
            <div className="stats-mini-grid">
              <div className="mini-box">
                <span>FOLLOWERS</span>
                <strong>{ghData?.followers || "0"}</strong>
              </div>
              <div className="mini-box">
                <span>FOLLOWING</span>
                <strong>{ghData?.following || "0"}</strong>
              </div>
            </div>
            ...
            <a
              ...
              rel="noreferrer"
              className="action-btn"
              style={{ borderColor: "#2ea043", color: "#2ea043" }}
            >
              VIEW_COMMITS.SH
            </a>
          </div>
            ...
            >
              ...
              <h2>
                ...
                <span style={{ color: "#2ea043" }}>
                  {ghData?.username?.toUpperCase() || "DEVELOPER"}
                </span>
              </h2>
            </div>
            <div className="exp-content">
              <div className="exp-stats-box">
                ...
                <p>
                  Stars Earned: <strong>{ghData?.totalStars || "0"}</strong> |
                  Forks: <strong>{ghData?.totalForks || "0"}</strong>
                </p>
                <p>
                  Top Languages:{" "}
                  <strong>
                    {/* This extracts the keys from your languagesUsed object (e.g., JavaScript, TypeScript, Python) */}
                    {ghData?.languagesUsed
                      ? Object.keys(ghData.languagesUsed).join(", ")
                      : "Loading..."}
                  </strong>
                </p>
              </div>
              <div className="terminal-log">
                <p className="log-line"> {">"} whoami</p>
                <p className="log-line">
                  {" "}
                  {">"} {ghData?.name}
                </p>
                <p className="log-line"> {">"} cat bio.txt</p>
                {/* Dynamically showing your bio text! */}
                <p className="log-line success" style={{ color: "#2ea043" }}>
                  {" "}
                  {">"} {ghData?.bio || "Code. Create. Innovate."}
                </p>
              </div>
            </div>
          </div>
